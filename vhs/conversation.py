...
class Conversation:
    ...
    def get_prompt(self):
        ...
        elif self.sep_style == SeparatorStyle.MINERVA or self.sep_style == SeparatorStyle.GEMMA_2 or self.sep_style == SeparatorStyle.QWEN_2:
...
#conv_vicuna_v1, conv_llama_2, conv_llava_llama_2, conv_mpt, conv_llava_plain, conv_llava_v0, conv_llava_v0_mmtag, conv_llava_v1, conv_llava_v1_mmtag, conv_mistral_instruct, conv_chatml_direct, 
...
conv_llava_minerva = Conversation(
    system="",
    roles=("user", "assistant"),
    version="minerva",
    messages=[],
    offset=0,
    sep_style=SeparatorStyle.MINERVA,
    tokenizer=llama_tokenizer,
    stop_token_ids=[2, 51202]
)
...
conv_templates = {
    ...
    "phi4": conv_phi4_instruct,
    "gemma_2": conv_llava_gemma_2,
    "qwen_2": conv_llava_qwen_2,
    "qwen_3": conv_llava_qwen_3,
    "minerva": conv_llava_minerva,
}
